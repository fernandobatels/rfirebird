...
pub mod tests {
    ...
    pub fn rle_decode_compressed() {
        let data = vec![0x01, 0xfe, 0xfd, 0x00, 0x03, 0x20, 0x00, 0x41, 0xfc, 0x61, 0x01, 0x42, 0xf7, 0x62, 0x01, 0x43, 0xf2, 0x63, 0x02, 0x44, 0x44];

        // AaaaaBbbbbbbbbbCccccccccccccccDD
        let eresult = vec![0xfe, 0x00, 0x00, 0x00, 0x20, 0x00, 0x41, 0x61, 0x61, 0x61, 0x61, 0x42, 0x62, 0x62, 0x62, 0x62, 0x62, 0x62, 0x62, 0x62, 0x62, 0x43, 0x63, 0x63, 0x63, 0x63, 0x63, 0x63, 0x63, 0x63, 0x63, 0x63, 0x63, 0x63, 0x63, 0x63, 0x44, 0x44];
    ...
    pub fn rle_decode_uncompressed() {
        let data = vec![0x01, 0xfe, 0xfd, 0x00, 0x0a, 0x08, 0x00, 0x46, 0x69, 0x72, 0x65, 0x62, 0x69, 0x72, 0x64, 0x00];

        // Firebird
        let eresult = vec![0xfe, 0x00, 0x00, 0x00, 0x08, 0x00, 0x46, 0x69, 0x72, 0x65, 0x62, 0x69, 0x72, 0x64];
